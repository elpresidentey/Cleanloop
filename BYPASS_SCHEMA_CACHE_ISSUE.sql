-- BYPASS SCHEMA CACHE ISSUE - EMERGENCY SOLUTION
-- This creates a direct database function that bypasses PostgREST entirely
-- Run this in Supabase Dashboard → SQL Editor

-- Step 1: Create a direct function for pickup requests that bypasses schema cache
...
-- Step 2: Create a direct function for payments
...
SELECT 'DIRECT DATABASE FUNCTIONS CREATED!' as result,
